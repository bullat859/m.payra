...
<body class="bg-slate-950 text-slate-100 min-h-screen selection:bg-blue-500 selection:text-white relative antialiased">
    ...
    <!-- COMPACT STICKY NAVBAR (Takes up horizontal space, minimal vertical space) -->
    <div class="sticky top-0 z-40 w-full mb-6 sm:mb-8 pt-1 sm:pt-2 px-2 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div class="glass-panel px-3 sm:px-5 py-2.5 sm:py-3 rounded-2xl sm:rounded-full shadow-lg shadow-black/40 flex flex-row items-center justify-between gap-3 border border-slate-700/50 transition-all">
            ...
            <div class="flex items-center gap-2.5 sm:gap-3 min-w-0">
                ...
                <!-- Short name for mobile, full name for desktop -->
                <span class="text-sm font-bold text-slate-100 truncate sm:hidden">Dynamic Edge</span>
                <span class="text-[15px] font-bold text-slate-100 truncate hidden sm:block">Dynamic Edge Gesture Control</span>
            </div>

            <!-- Right Side: Document Type -->
            <div class="flex items-center gap-3 shrink-0">
                <div class="hidden sm:block w-px h-5 bg-slate-700"></div>
                <span class="text-xs sm:text-sm font-extrabold tracking-wide uppercase bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
                    Privacy Policy
                </span>
            </div>
        </div>
